 ...
 * @Date: 2024-08-29 18:52:55
 * @LastEditors: chaijunlin chaijunlin@sanfawork.com
 * @LastEditTime: 2024-08-30 17:55:21
 * @FilePath: \uniapp-weixin-template\upload.js
...
console.qr = require('./qr.js/index.js')
...
const appid = 'wx16318dc06482ef23'
let versions = '1.0.1'
let descs = '1.0.1'
...
    privateKeyPath: path.join(__dirname, './private.wechart.key'), // 密钥的路径
